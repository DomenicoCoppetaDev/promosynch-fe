...
import { Calendar3, Justify, PeopleFill, PlusCircle, PersonCircle  } from 'react-bootstrap-icons';
...
export default function SideBar() {
  ...
  return (
    <Container fluid
      className={cn(
        styles.sidebar,
        'position-fixed', // Aggiunto per posizionare la barra lateralmente solo su schermi LG e XL
        'd-none',
        'd-lg-block',
        'py-5',
        'fixed-left', // Aggiunto per posizionare la barra a sinistra
        'text-white',
      )}
    >
