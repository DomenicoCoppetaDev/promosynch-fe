...
export default function Login() {
    ...
    return (
        ...
        <Container className={cn(styles.back,'d-flex align-items-center justify-content-center p-0')}>
                ...
                <Col>
                    <div className={cn(styles.cardLogin,'shadow rounded pb-4')} >
                        <div className={cn(styles.loginCardTitle,'text-center p-4 mb-4')}>
                            ...
                            <h3 className='my-2'>PROMOSYNCH</h3>
                        ...
                        <Form onSubmit={handleLogin} className='mx-3'>
                            ...
                            <div className='d-grid gap-2 mx-0 px-0'>
                                <Button className='mx-0 w-100 shadow-sm' type="submit" >Login</Button>
                                <MyGoogleLoginButton 
                                ...
                                <Button className='mx-0 w-100 shadow-sm' onClick={() => handleNavigate('/promoters/register')}>Register</Button>
                            </div>
                        </Form>
                    </div>
                </div>
